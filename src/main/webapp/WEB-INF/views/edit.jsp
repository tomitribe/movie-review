...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form action="${pageContext.request.contextPath}/r/review/save" method="POST" class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control" id="firstname" name="firstname" placeholder="First name"
                   value="${review.firstname}" autofocus>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Last name"
                   value="${review.lastname}" autofocus>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control" id="moviename" name="moviename" placeholder="Movie name"
                   value="${review.moviename}" autofocus>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control" id="directorname" name="directorname" placeholder="Director name"
                   value="${review.directorname}" autofocus>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="number" min="1" max="10" class="form-control" id="movierating" name="movierating" placeholder="Movie Rating"
                value="${review.movierating}" autofocus>
          </div>
        </div>
        <div class="form-group">
          <label for="notes" class="col-sm-4 control-label">Notes</label>
          <div class="col-sm-6">
            <textarea id="notes" name="notes" class="form-control" rows="5" autofocus>${review.notes}</textarea>
          </div>
        </div>
